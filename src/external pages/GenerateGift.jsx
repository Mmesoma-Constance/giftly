...
export default function GenerateGift() {
  ...
  function surpriseMe() {
    ...
    setAge(p.age); setGender(p.gender); setRelationship(p.relationship);
    setOccasion(p.occasion); setBudget(p.budget); setInterests(p.interests);
    setShaking(true);
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="sm:col-span-2 flex flex-col gap-2">
              ...
              <div className="mt-1">
                ...
                <div className="flex justify-between mt-2 text-[.72rem] font-bold
                  text-[#2C1A12]/40 tracking-wide">
            ...
            >
              <span className="flex-1 text-sm text-[#2C1A12]/60 leading-snug min-w-0">
                ...
                Let us pick a random profile and generate surprise results for you!
              </span>
