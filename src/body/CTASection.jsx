...
const CTASection = () => {
  ...
  const handleHowItWorks = useCallback((e) => {
    e.preventDefault();
    if (isHome) {
      scrollToSection("how-it-works");
    } else {
      navigate("/");
      setTimeout(() => scrollToSection("how-it-works"), 120);
    }
  ...
  return (
    <section className="text-center px-5 py-24 relative overflow-hidden"
      ...
      <span className="text-[.72rem] font-bold tracking-[.14em] uppercase text-rose mb-[14px] block">
      ...
      <div className="flex gap-[14px] justify-center flex-wrap">
        ...
        <a
          ...
          className="inline-flex items-center justify-center bg-white text-ink font-bold
            text-[1rem] px-9 py-3 sm:py-4.25 rounded-full border-[1.5px] border-ink-15
            cursor-pointer shadow-s1 hover:border-ink-30 hover:-translate-y-0.5
            hover:shadow-s2 transition-all"
        >
          How It Works
        </a>
      </div>
